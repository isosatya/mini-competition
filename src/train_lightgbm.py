...
This module trains a LightGBM model on the featured data with GPU support.
...
def train_model(X_train, y_train):
    ...
    grid_search = GridSearchCV(
        ...
        n_jobs=-1,
        verbose=1  # Show progress for grid search
    )
...
def save_model(model, metrics):
    ...
    # Save metrics
    metrics_path = models_dir / "lightgbm_metrics.txt"
